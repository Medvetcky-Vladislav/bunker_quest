...
def room_hranilishe():
    ...
    if built["g1"] == True:
        ...
        if built["g1"] == True:
            ...
            if ans7 == "бой":
                print("Вы начали бой, но потом понимаете, что на вас действует споры токсичной плесени, и вы дерётесь не с монстрами, а между собой, но уже поздно, вы проиграли")
                exit()
            elif ans7 == "мир":
