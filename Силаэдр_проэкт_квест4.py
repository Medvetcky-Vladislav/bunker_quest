...
def room_podezd():
    global inventory
    print("Вы в комнате подъезд (без газов грибочков), вы читаете справочник и находите там, что в этом бункере хранились галлюциногенные грибочки, и их газы распространились по комнатам и вокруг бункера из-за неисправной вентиляции")
    ...
    if ans3 == "открыть":
        print("Галлюциногенный газ вышел, но залетела радиация, вы умерли :(")
        exit()
...
def room_zal():
    ...
    print(f'Вы в зале. Вы пойдёте в комнату хранилище ({g11}), вы видите там много еды и воды, или в комнату генератор, там ничего нет, но есть генератор электричества (без газов грибочков) и странная электрическая дверь')
    ...
    if built["g1"] == True:
        ...
        if built["g1"] == True:
            ...
            if ans7 == "бой":
                ...
                print("Через какое-то время вы понимаете, что это не монстры, а другая часть ваших выживших, из-за того что на вас действовал галлюциногенный газ, и вы продолжаете дорогу")
            else:
                print("Ответ введён неверно, введите ответ заново")
                room_hranilishe()

    print(f'Вы в хранилище. Вы пойдёте в комнату зал (без газов) или в комнату генератор, там ничего нет, но есть генератор электричества (без газов грибочков) и странная электрическая дверь, или в комнату с запасами воды (без газов)')
...
def room_generator():
    ...
    if built["g1"] == True:
        ...
        g11 = "без газов грибочков"
    print(f'Вы в комнате генератор электричества. Вы пойдёте в комнату хранилище ({g11}) или в комнату зал (без газов), или в комнату теплица (без газов грибочков)')
